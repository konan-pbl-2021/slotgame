...
public class Slot_kantan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slot_kantan);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(timer == null){
                    ...
                    timer = null;
                    timer = new Timer();}
                textAnimation(textView, 0, 10, 70, 1000); // i を１増やす
//                textAnimation(textView, 0, 10, 500, 30);//テスト用
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textAnimation2(textView2, 0, 10, 100, 1000); // i を１増やす
...
//                textAnimation3(textView3, 0, 10, 90, 10); // i を１増やす
                textAnimation3(textView3, 0, 10, 500, 1000);
            }
...
//                    value += blockValue;
    ...
    private void countcheck() {
        ...
        if ((a == b) && (b == c) && (a == c)) {
            ...
            tmpk=-3;
            if(l == 3){
                Intent intent = new Intent(Slot_kantan.this,win.class);
